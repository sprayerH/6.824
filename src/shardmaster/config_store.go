...
func (c *ConfigStore) Join(newGroups map[int][]string) string {
...
func (c *ConfigStore) Leave(gids []int) string {
	newConfig := c.newBaseConfig()
...
func (c *ConfigStore) Move(shard, gid int) string {
	newConfig := c.newBaseConfig()
...
func (c *ConfigStore) Query(num int) (Config, Err) {
